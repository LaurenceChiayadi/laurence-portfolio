...
const Tech = () => {
  ...
  return (
    <div
      id="text"
      className="flex z-10 min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32"
    >
      <motion.h1
        variants={variants}
        initial="hidden"
      ...
      <div className="flex flex-wrap items-center justify-center gap-10 p-5">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <BiLogoFlutter className="cursor-pointer text-[80px] text-sky-500 transition-all duration-300 hover:-translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        <motion.div
          variants={variants}
          initial="hidden"
